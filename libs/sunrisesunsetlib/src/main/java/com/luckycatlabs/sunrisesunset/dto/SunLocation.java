...
/*
 * Renamed from Location to SunLocation by Jacob for pressureNET
 * to avoid conflicts with Android's Location class
 */
...
public class SunLocation {
     ...
     */
    public SunLocation(String latitude, String longitude) {
     ...
     */
    public SunLocation(double latitude, double longitude) {
        this.latitude = new BigDecimal(latitude);
        this.longitude = new BigDecimal(longitude);
    }
