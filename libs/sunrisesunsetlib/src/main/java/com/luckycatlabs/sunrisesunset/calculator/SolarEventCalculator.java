...
public class SolarEventCalculator {
    final private SunLocation location;
     ...
     *            "America/New_York".
     */
    public SolarEventCalculator(SunLocation location, String timeZoneIdentifier) {
     ...
     */
    public SolarEventCalculator(SunLocation location, TimeZone timeZone) {
        this.location = location;
