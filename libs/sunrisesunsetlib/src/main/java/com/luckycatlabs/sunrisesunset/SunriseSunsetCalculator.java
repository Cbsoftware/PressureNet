...
public class SunriseSunsetCalculator {
     ...
     *            time zones.
     */
    public SunriseSunsetCalculator(SunLocation location, String timeZoneIdentifier) {
     ...
     */
    public SunriseSunsetCalculator(SunLocation location, TimeZone timeZone) {
    ...
    public static Calendar getSunrise(double latitude, double longitude, TimeZone timeZone, Calendar date, double degrees) {
        SolarEventCalculator solarEventCalculator = new SolarEventCalculator(new SunLocation(latitude, longitude), timeZone);
     ...
     */
    public SunLocation getLocation() {
        return location;
    }
}
